    ...
    private fun setListeners(){
        binding?.apply {
            dollar.setOnClickListener{
                val bundle = bundleOf(ARG_CURRENCY to Currencies.USD.name)
            ...
            pound.setOnClickListener{
                val bundle = bundleOf(ARG_CURRENCY to Currencies.GBP.name)
                Navigation.findNavController(it).navigate(R.id.action_homeFragment_to_listFragment, bundle)
            }
            yen.setOnClickListener{
                val bundle = bundleOf(ARG_CURRENCY to Currencies.JPY.name)
                Navigation.findNavController(it).navigate(R.id.action_homeFragment_to_listFragment, bundle)
            }
        }
    }
